...
public class pivotAngle extends CommandBase {
  ...
  public double setPoint;
    public pivotAngle(double setPoint) {
  ...
  public void execute() {
    double output;
    output = (pid.calculate(elevatormotors.getElevatormotorsInstance().getPivot(), setPoint));
    elevatormotors.getElevatormotorsInstance().pivotrotation(output);
    }
