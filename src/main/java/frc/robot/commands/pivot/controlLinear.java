...
public class controlLinear extends CommandBase {
  ...
  public void initialize() {
    linearExtender.getInstance().setSetPointLinear(extension);
  }
  ...
  public boolean isFinished() {
    return (Math.abs(extension - linearExtender.getInstance().getExtension()) < Units.inchesToMeters(1)) && linearExtender.getInstance().getExtensionRate() < .05; 
  }
}
